...
export function ChatWindow(props: {
  ...
  const titleText = browserOnly ? "OttoDev - Fully In-Browser Chat" : "OttoDev - Fully Local Chat";
    ...
    <>
      <div className="p-4 md:p-8 rounded bg-[#25252d] w-full max-h-[85%] overflow-hidden flex flex-col">
        <h1 className="text-3xl md:text-4xl mb-2 ml-auto mr-auto">
          {emoji} OttoDev - Fully {browserOnly ? "In-Browser" : "Local"} Chat Over Documents {emoji}
        </h1>
        ...
        <ul>
          ...
          <li className="hidden text-l md:block">
            🌐
            <span className="ml-2">
              The vector store (<a target="_blank" href="https://github.com/tantaraio/voy">Voy</a>) and embeddings (<a target="_blank" href="https://huggingface.co/docs/transformers.js/index">Transformers.js</a>) run fully in the browser with no setup required.
            </span>
          </li>
          {browserOnly 
            ? (
            ...
            : (
                <li>
                  ...
                  <span className="ml-2">
                    ...
                    <br/>
                    <pre className="inline-flex px-2 py-1 my-2 rounded">$ OLLAMA_ORIGINS=* OLLAMA_HOST=127.0.0.1:11435 ollama serve
                    </pre>
                    <br/>
          ...
          <li className="text-l">
            🐙
            <span className="ml-2">
              OttoDev is open source - you can see the source code and
              deploy your own version{" "}
              <a
                href="https://github.com/ottodev-ai/document-chatbot"
                target="_blank"
              >
